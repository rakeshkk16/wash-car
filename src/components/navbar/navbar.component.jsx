            ...
            <div className="nav-bar">
                <div className="container">
                    <nav className="navbar navbar-expand-lg bg-dark navbar-dark">
                        <a href="https/www.google.com" className="navbar-brand">MENU</a>
                        ...
                        <div className="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div className="navbar-nav mr-auto">
                                ...
                                <div className="nav-item dropdown">
                                    <a href="https/www.google.com" className="nav-link dropdown-toggle" data-toggle="dropdown">Pages</a>
                            ...
                            <div className="ml-auto">
                                <a className="btn btn-custom" href="https/www.google.com">Get Appointment</a>
                            </div>
                        </div>
                    </nav>
                </div>
